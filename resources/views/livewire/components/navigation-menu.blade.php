            ...
            <div class="flex justify-between h-16">
                <div class="flex px-2 lg:px-0">
                    ...
                    <nav aria-label="Global" class="hidden lg:ml-6 lg:flex lg:items-center lg:space-x-4">
                        ...
                        <a href="#" class="px-3 py-2 text-sm font-medium text-gray-900"> Applicants </a>
                        ...
                        <ol role="list" class="flex items-center space-x-4">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="#"
                                        class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Jobs</a>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="#" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700"
                                        aria-current="page">Applicants</a>
                                </div>
                            </li>
                        </ol>
                    </div>
    ...
    <main class="py-10">
        ...
        <div
            ...
            <div
                ...
                <button type="button"
                    class="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-blue-500">Disqualify</button>
                <button type="button"
            ...
            <div class="space-y-6 lg:col-start-1 lg:col-span-2">
                ...
                <section aria-labelledby="applicant-information-title">
                    <div class="bg-white shadow sm:rounded-lg">
                        ...
                        <div>
                            <a href="#"
                                class="block px-4 py-4 text-sm font-medium text-center text-gray-500 bg-gray-50 hover:text-gray-700 sm:rounded-b-lg">Read
                                full application</a>
                        </div>
                    </div>
                </section>
